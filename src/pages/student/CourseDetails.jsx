...
const CourseDetails = () => {
    ...
    return courseData ? (
        <>
            <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 mt:Pt-30 pt-20 text-left'>
                ...
                <div className='max-w-xl z-10 text-gray-500'>
                        ...
                        <div className='pt-5'>
                            {courseData.courseContent.map((chapter, index) => (
                                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                                    <div onClick={() => toggleSections(index)} className='flex items-center justify-between px-4 py-3 cursor-pointer select-none'>
                    ...
                    <div className='py-20 text-sm md:text-default'>
                        <h3 className='text-xl fonr-semibold text-gray-800'>Course Description</h3>
